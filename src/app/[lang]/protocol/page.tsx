        ...
        <div className="min-h-screen bg-black text-white font-sans selection:bg-emerald-500/30 overflow-x-hidden">
            ...
            <nav className="flex justify-between items-center px-8 py-6 border-b border-white/5 backdrop-blur-xl bg-black/40 sticky top-0 z-50">
                ...
                <div className="hidden md:flex gap-10 items-center text-xs font-bold uppercase tracking-widest text-zinc-500">
                    <Link href={`/${lang}/protocol`} className="text-white transition-colors">{dict.nav.protocol}</Link>
                    ...
                    <a href="https://symbol.science" className="flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/5 text-[10px] font-mono text-blue-400 hover:bg-blue-500/10 transition-colors uppercase tracking-widest">
